...
public class RoewayChunkProvider implements IChunkProvider {
    ...
    {
        this.field_147426_g = this.noiseGen6.generateNoiseOctaves(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, (double)this.chunkProviderSettings.depthNoiseScaleX, (double)this.chunkProviderSettings.depthNoiseScaleZ, (double)this.chunkProviderSettings.depthNoiseScaleX);
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA) && !flag && this.rand.nextInt(this.chunkProviderSettings.lavaLakeChance / 10) == 0 && this.chunkProviderSettings.useLavaLakes)
        {
            ...
            if (l1 < 63 || this.rand.nextInt(this.chunkProviderSettings.lavaLakeChance / 8) == 0)
            {
