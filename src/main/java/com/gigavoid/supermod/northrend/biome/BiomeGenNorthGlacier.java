...
import com.gigavoid.supermod.northrend.worldgen.tree.NorthrendWorldGenGlacierBoulders;
...
public class BiomeGenNorthGlacier extends NorthrendBiomeGenBase {
    ...
    NorthrendWorldGenGlacierBoulders crackGen = new NorthrendWorldGenGlacierBoulders(true);
