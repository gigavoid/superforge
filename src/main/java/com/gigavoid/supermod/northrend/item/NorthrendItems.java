...
public class NorthrendItems {
    ...
    public static void registerItems(FMLInitializationEvent e, Register register){
        ...
        register.registerItemWithTexture(northLeatherLeggins, "north_leather_leggings", "minecraft:leather_leggings", e);
        ...
        register.registerItemWithTexture(northChainmailLeggins, "north_chainmail_leggings", "minecraft:chainmail_leggings", e);
        ...
        register.registerItemWithTexture(northIronLeggins, "north_iron_leggings", "minecraft:iron_leggings", e);
        ...
        register.registerItemWithTexture(northDiamondLeggins, "north_diamond_leggings", "minecraft:diamond_leggings", e);
        register.registerItemWithTexture(northDiamondBoots, "north_diamond_boots", "minecraft:diamond_boots", e);
        register.registerItemWithTexture(northGoldHelmet, "north_golden_helmet", "minecraft:golden_helmet", e);
        register.registerItemWithTexture(northGoldChestplate, "north_golden_chestplate", "minecraft:golden_chestplate", e);
        register.registerItemWithTexture(northGoldLeggins, "north_golden_leggings", "minecraft:golden_leggings", e);
        register.registerItemWithTexture(northGoldBoots, "north_golden_boots", "minecraft:golden_boots", e);
